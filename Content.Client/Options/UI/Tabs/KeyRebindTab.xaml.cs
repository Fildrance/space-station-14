...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class KeyRebindTab : Control
    {
        ...
        // private readonly CreateNewCustomBindingPanel _newCustomBindingPanel;
        ...
        public KeyRebindTab()
        {
            ...
            AddHeader("ui-options-header-text-other");
            // _newCustomBindingPanel = new CreateNewCustomBindingPanel();
            // KeybindsContainer.Children.Add(_newCustomBindingPanel);
            var addNewBinding = new Button
            {
                Text = "Add custom command binding",
                MaxWidth = 300
            };
            KeybindsContainer.Children.Add(addNewBinding);
            #endregion
        }
