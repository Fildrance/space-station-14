...
internal sealed partial class ChatManager : IChatManager
{
    ...
    public void SendChannelMessage(string message, string communicationChannel, ICommonSession? senderSession, EntityUid? senderEntity, HashSet<ICommonSession>? targetSessions = null, bool escapeText = true, ChatMessageContext? supplierParameters = null, bool logMessage = true)
    {
    ...
    public void SendChannelMessage(FormattedMessage message, string communicationChannel, ICommonSession? senderSession, EntityUid? senderEntity, HashSet<ICommonSession>? targetSessions = null, ChatMessageContext? supplierParameters = null, bool logMessage = true)
    {
    ...
    public void SendChannelMessage(FormattedMessage message, string communicationChannel, ICommonSession? senderSession, EntityUid? senderEntity, ref List<CommunicationChannelPrototype> usedCommsTypes, HashSet<ICommonSession>? targetSessions = null, ChatMessageContext? supplierParameters = null, bool logMessage = true)
    {
        _prototypeManager.TryIndex<CommunicationChannelPrototype>(communicationChannel, out var proto);
        ...
        bool logMessage = true)
    {
        ...
        if (senderSession != null)
        {
            ...
            bool allowPublish = basePublishChatCondition.Check(new ChatMessageConditionSubject(senderSession), compiledChannelParameters);
